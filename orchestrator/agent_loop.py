...
def _generate_closing_line(
    ...
    prompt = (
        "You're the Mission Agent — a friendly, competent financial concierge — voicing the LAST "
        "spoken line of a live demo. Sound like a friend who just finished a favour for you. "
        "Use a contraction. Casual rhythm. Avoid robot vocabulary (no 'executing', 'processing', "
        "'transaction complete', 'kindly').\n\n"
        f"Outcome: {status_hint}.\n"
        f"Earlier narrations you've spoken this run:\n{bullets or '(none)'}\n"
        f"Pre-approval summary you delivered: {summary}\n\n"
        "Reply with EXACTLY ONE short sentence (8 to 14 words). No quote marks. "
        "Don't repeat phrasing from earlier narrations — vary the rhythm. End with a period."
    )
